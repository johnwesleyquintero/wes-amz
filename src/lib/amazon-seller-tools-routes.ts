export const amazonSellerToolsNavigation = [
  { name: "ACOS Calculator", href: "/tools/acos-calculator" },
  {
  ...
  { name: "Keyword Analyzer", href: "/tools/keyword-analyzer" },
  {
  ...
  {
    name: "Listing Hijack Alerts",
    href: "/tools/listing-hijack-alerts",
  },
  {
  ...
  { name: "Sales Estimator", href: "/tools/sales-estimator" },
  {
