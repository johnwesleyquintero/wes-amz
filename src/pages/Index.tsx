...
const CoreValuePropsSection: React.FC<CoreValuePropsSectionProps> = ({ data }) => (
...
const FeatureDeepDiveSection: React.FC<FeatureDeepDiveSectionProps> = ({ data }) => (
...
const CustomerCaseStudySection: React.FC<CustomerCaseStudySectionProps> = ({ data }) => (
